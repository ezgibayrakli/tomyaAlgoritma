...
let indexdeger13 = kalaniBul(array[4], array[5][0]);
let indexdeger14 = kalaniBul(array[4], array[5][1]);
let indexdeger15 = kalaniBul(array[4], array[5][2]);
let indexdeger16 = kalaniBul(array[4], array[5][3]);
let indexdeger17 = kalaniBul(array[4], array[5][4]);

console.log(`78521 Sayımızdan gelen değer = ${indexdeger13 + indexdeger14 + indexdeger15 + indexdeger16 + indexdeger12}`);
