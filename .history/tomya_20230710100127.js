...
let indexdeger5 = kalaniBul(array[2],array[3][1])
let indexdeger6 = kalaniBul(array[2],array[3][2])
let indexdeger7 = kalaniBul(array[2],array[3][3])

console.log(`554 Sayımızdan gelen değer = ${indexdeger5 + indexdeger6 + indexdeger3 + indexdeger4}`)
