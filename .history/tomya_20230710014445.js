...
let indexdeger1 = console.log(array[i],array[0][0])
let indexdeger2 = console.log(array[i],array[0][1])
let indexdeger3 = console.log(array[i],array[0][2])
let indexdeger4 = console.log(array[i],array[0][3])
