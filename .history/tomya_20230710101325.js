...
let indexdeger8 = kalaniBul(array[4], array[3][0]);
let indexdeger9 = kalaniBul(array[4], array[3][1]);
let indexdeger10 = kalaniBul(array[4], array[3][2]);

console.log(`68921 Sayımızdan gelen değer = ${indexdeger5 + indexdeger6 + indexdeger7}`);
