...
let indexdeger21 = kalaniBul(array[8], array[9][3]);
let indexdeger22 = kalaniBul(array[8], array[9][4]);

console.log(`123 Sayımızdan gelen değer = ${indexdeger18 + indexdeger19 + indexdeger20 + indexdeger21 + indexdeger227}`);