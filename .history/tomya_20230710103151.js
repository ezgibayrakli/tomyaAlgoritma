...
let indexdeger18 = kalaniBul(array[8], array[7][0]);
let indexdeger19 = kalaniBul(array[8], array[7][1]);
let indexdeger20 = kalaniBul(array[8], array[7][2]);
let indexdeger21 = kalaniBul(array[8], array[7][3]);
let indexdeger22 = kalaniBul(array[6], array[7][4]);

console.log(`123 Sayımızdan gelen değer = ${indexdeger18 + indexdeger19 + indexdeger20 + indexdeger21 + indexdeger17}`);